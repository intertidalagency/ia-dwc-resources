...
![Standards in the data lifecycle (*Click to enlarge*)](img/excalidraw_illustrations/standards_in_the_data_life_cycle.svg){width="80%" fig-alt="Diagram showing how standards integrate into the data lifecycle"}
...
![Trawl data mapping overview (*Click to enlarge*)](img/excalidraw_illustrations/trawl_mapping.svg){width="80%" fig-alt="Overview diagram of how trawl data maps to Darwin Core structure"}
...
![Temporal data mapping (*Click to enlarge*)](img/excalidraw_illustrations/trawl-when.svg){width="80%" fig-alt="Diagram showing how temporal data maps to Darwin Core terms"}
...
![Spatial data mapping (*Click to enlarge*)](img/excalidraw_illustrations/trawl-where.svg){width="80%" fig-alt="Diagram showing how spatial data maps to Darwin Core terms"}
...
![Biological data mapping (*Click to enlarge*)](img/excalidraw_illustrations/trawl-what.svg){width="80%" fig-alt="Diagram showing how biological data maps to Darwin Core terms"}
...
![Extended Measurement or Fact data (*Click to enlarge*)](img/excalidraw_illustrations/trawl-emof.svg){width="80%" fig-alt="Diagram showing how additional measurements are captured using the eMoF extension"}
...
![ATN data mapping overview (*Click to enlarge*)](img/excalidraw_illustrations/atn_mapping.svg){width="80%" fig-alt="Overview diagram of how satellite telemetry data maps to Darwin Core"}
...
![Deployment event data (*Click to enlarge*)](img/excalidraw_illustrations/atn-deployment.svg){width="80%" fig-alt="Diagram showing how deployment events are captured in Darwin Core"}
...
![Individual occurrence data (*Click to enlarge*)](img/excalidraw_illustrations/atn-occurrences.svg){width="80%" fig-alt="Diagram showing how individual satellite pings are captured as occurrences"}
...
![ATN eMoF extension data (*Click to enlarge*)](img/excalidraw_illustrations/atn-emof.svg){width="80%" fig-alt="Diagram showing how telemetry-specific measurements are captured using eMoF"}
...
![Multiple paths to success (*Click to enlarge*)](img/excalidraw_illustrations/many_paths.svg){width="80%" fig-alt="Illustration showing multiple paths up a mountain, representing different approaches to data standardization"}
