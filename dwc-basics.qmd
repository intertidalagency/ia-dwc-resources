...
![Data types that fit Darwin Core (*Click to enlarge*)](img/excalidraw_illustrations/data_types.svg){width="80%" fig-alt="Diagram showing various biological data types that can use Darwin Core"}
...
![Darwin Core Archive structure (*Click to enlarge*)](img/excalidraw_illustrations/DwC-A.svg){width="80%" fig-alt="Diagram showing the components of a Darwin Core Archive"}
...
![Single Darwin Core term example (*Click to enlarge*)](img/excalidraw_illustrations/single_DwC_term.svg){width="80%" fig-alt="Diagram showing how a single Darwin Core term standardizes data description"}
