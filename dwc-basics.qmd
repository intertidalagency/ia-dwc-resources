...
When you look at those requirements, they're rather simple: What did you see (`scientificName`), when (`eventDate`) and where (`decimalLatitude`/`decimalLongitude`) did you see it, how did you see it (`basisOfRecord`), and how do we reference this record (`eventID` and `occurrenceID`).
