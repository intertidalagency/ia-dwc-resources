...
::: {.g-col-4}
![](img/excalidraw_illustrations/no_standard.svg){width=80% fig-alt="A drawing of two people exchanging data without a standard.".lightbox}
:::
::: {.g-col-8}
...
::: {.grid .align-items-center}
::: {.g-col-4}
![](img/excalidraw_illustrations/closed_standard.svg){fig-alt="A drawing of a person giving data to a closed database." width=80% .lightbox} 
:::
::: {.g-col-8}
#### Closed standard
...
::: {.grid .align-items-center}
::: {.g-col-4}
![](img/excalidraw_illustrations/open_standard.svg){fig-alt="A drawing of data being exchanged across the world via an open standard." width=100% .lightbox}
:::
::: {.g-col-8}
#### Open standard
...
![](img/excalidraw_illustrations/general_data_flow.svg)
...
![](img/excalidraw_illustrations/efficiency.svg)
